...
if __name__ == "__main__":
    ...
    parser.add_argument('-annot', type=str, default = '/home/intern/protein/snowball/Contrastive Learning for 3D/preprocessing/data/nrPDB-GO_2020.06.18_annot.tsv', help="Input file (*.tsv) with preprocessed annotations.")
